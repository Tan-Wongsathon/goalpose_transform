...
int main(int argc, char** argv){
  ...
  while (node.ok()){
    ...
    pose_msg.pose.position.x = sqrt(pow((userpose_msg.pose.position.x - transformStamped.transform.translation.x),2.0)) ;
    pose_msg.pose.position.y = sqrt(pow((userpose_msg.pose.position.y - transformStamped.transform.translation.y),2.0)) ;
    pose_msg.pose.position.z = sqrt(pow((userpose_msg.pose.position.z - transformStamped.transform.translation.z),2.0)) ;
